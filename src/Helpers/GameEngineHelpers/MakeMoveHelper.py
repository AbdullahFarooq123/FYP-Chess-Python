...
from src.Helpers.PreCalculationHelpers.BitManipulationHelpers import unsigned, get_least_bit_index, remove_bit, \
...
def __perform_movement_on_board_states(game_state_model: GameState, decrypted_moves: Encryption,
    ...
    # Change player state
    game_state_model.player_attr.player_state = move_bit_by_position(board=player_state,
