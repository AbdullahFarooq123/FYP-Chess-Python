from UnitTests.TestData.RookTestData import rook_attacks_inc_ends, rook_attacks_exc_ends, rook_attack_counts
...
from src.Root.PreCalculationsData import rook_attacks, rook_attack_count
