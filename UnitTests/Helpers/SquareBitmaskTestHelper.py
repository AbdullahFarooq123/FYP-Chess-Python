...
from src.Helpers.PreCalculationHelpers.BitManipulationHelpers import bitmask
from src.Root.PreCalculationsData import square_bitmask
from UnitTests.TestData.SquareBitmaskTestData import tested_square_bitmask
